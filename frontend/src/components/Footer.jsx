...
export default function Footer({ onShowCookies }) {
      ...
      <div className="flex flex-col md:flex-row justify-between items-center w-full mb-3 gap-4">
        <div className="text-left w-full md:w-1/3">
          <p className="text-sm font-semibold text-gray-600">
            {t('footer.connect')}<sup>®</sup>
          </p>
          <a
            href="mailto:auto.mercedes21@gmail.com"
            className="text-lg font-bold underline hover:text-blue-600 transition"
          >
        ...
        <div className="flex justify-end items-center w-full md:w-1/3 text-sm space-x-4">
          ...
          <button
            ...
            className="hover:underline text-black focus:outline-none"
          >
          ...
          <a
            href="#top"
            className="text-base font-semibold hover:underline text-black"
          >
            ⤴ {t('footer.backToTop')}
          </a>
        </div>
